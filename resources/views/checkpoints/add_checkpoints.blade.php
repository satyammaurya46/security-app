                                 ...
                                 <div class="page-title">
                                     <h4>Add Checkpoint</h4>
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Add Checkpoint</li>
                                         </ol>
                                 </div>
                             </div>
                             <div class="col-sm-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="custom-validation" action="{{route('checkpoint.store')}}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" required
                                                                parsley-type="text" name="checkpoint_name" id="checkpoint_name" placeholder="Enter Checkpoint Name*"/>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <div>
                                                        <input parsley-type="url" type="text" class="form-control"
                                                              name="location" id="location"  required placeholder="Enter Location"/>
                                                    </div>
                                                </div>
                                                {{-- <div class="mb-3">
                                                    <label>Digits</label>
