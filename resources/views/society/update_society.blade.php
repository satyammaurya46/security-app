                    ...
                    <div class="col-sm-6">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('society-list') }}"> Update Society</a>
                                </li>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="custom-validation" action="{{ route('society.update', $society->id) }}" method="POST"
                                    novalidate>
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="society_type"
                                                id="commercial" value="Commercial" required {{$society->society_type=="Commercial"?'checked':''}}>
                                            <label class="form-check-label" for="commercial">Commercial</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="society_type"
                                                id="residential" value="Residential" required {{$society->society_type=="Residential"?'checked':''}}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" id="hdnDesignation" value="{{$society->designation}}"/>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="society_name" id="society_name"
                                            required placeholder="Enter Designation" value="{{(!empty($society)?$society->society_name:'')}}"/>
                                    </div>
...
<script>
    ...
    function getDesignationByType()
    {
        var selectedDept=$("#hdnDesignation").val();
        ...
        if (selectedValue == 'Commercial') {
            option += '<option value="Office admin" '+(selectedDept=="Office admin"?"selected":"")+'>Office admin</option>';
            option += '<option value="Manager" '+(selectedDept=="Manager"?"selected":"")+'>Manager</option>';
            option += '<option value="Vice President" '+(selectedDept=="Vice President"?"selected":"")+'>Vice president</option>';
            option += '<option value="President" '+(selectedDept=="President"?"selected":"")+'>President</option>';
        } else if (selectedValue == 'Residential') {
            option += '<option value="Manager" '+(selectedDept=="Manager"?"selected":"")+'>Manager</option>';
            option += '<option value="Chairman" '+(selectedDept=="Chairman"?"selected":"")+'>Chairman</option>';
        }
